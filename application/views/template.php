        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 py-4">
                    ...
                    <p class="text-muted">Created to add new tasks. New tasks can be added by anyone. Only the admin can edit. Anyone can sort all tasks</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="py-5 text-center">
        ...
        <h2>Task list</h2>
        <p class="lead">The list of all tasks is displayed below, to add a new task use the this button <a href="/add" class="btn btn-success">Add</a></p>
    </div>
